...
public class LISTVIEW_ADAPTER extends BaseAdapter {
    ...
    public ArrayList<com.example.data3.ui.gallery.LISTVIEW_ITEM> listViewItemList = new ArrayList<com.example.data3.ui.gallery.LISTVIEW_ITEM>();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.data3.ui.gallery.LISTVIEW_ITEM LISTVIEWITEM = listViewItemList.get(position);
    ...
    public void addItem(String title, String booking,String diseasename,String vaccinename,String address,String distance,String total) {
        com.example.data3.ui.gallery.LISTVIEW_ITEM item = new LISTVIEW_ITEM();
